# -*- coding: latin-1 -*-
# Test the different presentation of tower in Code_Aster
...
# ======================== EXPORTATION ========================
maillage.ExportMED(r'./Eolien/Code_Aster/Tower/Maillage.mmed', False, SMESH.MED_V2_2, 1, 
                   None ,1)
print ('Mesh has been exported to ./Eolien/Code_Aster/Tower/Maillage.mmed')
